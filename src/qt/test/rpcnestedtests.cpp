...
void RPCNestedTests::rpcNestedTests()
{
    ...
    ClearDatadirCache();
    std::string path = QDir::tempPath().toStdString() + "/" + strprintf("test_mircoin_qt_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
    ...
    QVERIFY(result == "68b8e2823f8d7a30c5b0ff1272ecbb519ccd5e5ce924a00b5ced468e045c9a2a");
