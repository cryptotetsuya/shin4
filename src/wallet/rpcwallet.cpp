...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            ...
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Mircoin address: ")+name_);
    ...
    if (request.params.size() > 2 && !request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                ...
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid Mircoin address: ")+input.get_str());
      ...
      if (request.params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!address.IsValid())
                ...
                throw JSONRPCError(RPC_INVALID_PARAMETER, "changeAddress must be a valid mircoin address");
