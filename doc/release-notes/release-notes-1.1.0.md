Mircoin Core version 1.1.0 is now available from:
...
* **The TestNet** has been released and ready for use. Add this node using terminal:
     `mircoin-cli addnode 5.189.152.67 add`
     
* [Mircoin Testnet Pool](https://testnet-pool.mircoin.tk/)
...
(in Mircoin Core 0.10.3) it has been disabled by default.
...
Mircoin Core has supported automatically pruning the blockchain since 0.11. Pruning
...
The Alert System was [disabled and deprecated](https://bitcoin.org/en/alert/2016-11-01-alert-retirement) in Mircoin Core 0.12.1 and removed in 0.13.0. 
